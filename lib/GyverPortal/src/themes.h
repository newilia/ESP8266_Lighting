...
"hr {width:95%;margin-bottom:10px;max-width:450px;}\n"
"h2 {margin:8px 0;}\n"
"span {font-size:20px;}\n"
"label {font-size:20px;margin:0 5px;}\n"
".chartBlock {border-radius:15px;margin:10px;width:90%;max-width:1000px;height:500px}\n"
".block {border-radius:10px;background-color:#f2f2f2;padding:15px 0px;margin-top:3px;margin-bottom:15px;width:90%;max-width:450px;}\n"
".sldBlock{width:90%;display:flex;flex-direction:row;justify-content:center;align-items:center}"
...
"{border-radius:8px;max-width:450px;padding:3px 10px;vertical-align:middle;position:relative;margin:2px 0 7px 0;font-size:20px;height:40px;cursor:pointer;}\n"
...
"input[type=\"submit\"],input[type=\"button\"] {max-width:450px;height:60px;font-size:28px;width:90%;margin:8px 5px;background-color:#4CAF50;border:none;border-radius:8px;color:white;cursor:pointer;padding:0px 10px;}\n"
...
"hr {width:95%;margin-bottom:10px;border:none;border-top:2px solid #394048;max-width:450px;}\n"
"h2 {margin:8px 0;}\n"
"span {font-size:20px;}\n"
"label {font-size:20px;margin:0 5px;}\n"
...
".sldLbl{font-size:15px;}"
"input[type=\"number\"],input[type=\"text\"],input[type=\"password\"],input[type=\"date\"],input[type=\"time\"],input[type=\"range\"],input[type=\"color\"],input[type=\"checkbox\"],select,textarea\n"
"{border-radius:8px;max-width:450px;padding:3px 10px;color:#bbb;border:none;background-color:#2a2d35;vertical-align:middle;position:relative;margin:2px 0 7px 0;font-size:20px;height:40px;cursor:pointer;}\n"
"input[type=\"range\"] {width:60%;height:30px;padding:0px;}\n"
"input[type=\"date\"],input[type=\"time\"] {width:180px;}\n"
"input[type=\"color\"] {width:80px;height:50px;}\n"
"input[type=\"checkbox\"] {width:27px;height:27px;margin-bottom:10px;}\n"
...
"input[type=\"submit\"],input[type=\"button\"] {max-width:450px;height:60px;font-size:28px;width:90%;margin:8px 5px;background-color:#4CAF50;border:none;border-radius:8px;color:white;cursor:pointer;}\n"
"input[type=submit],input[type=\"button\"]:hover {background-color:#45a049;}\n"
