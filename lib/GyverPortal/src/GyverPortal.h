...
inline Builder add;    //extern Builder add = Builder();
inline Builder GP;     //extern Builder GP = Builder();
...
// ===================== DEPRECATED =====================
inline void GP_BUILD(__attribute__((unused)) String& s) {
    //_GP = &s;
}
inline void BUILD_BEGIN(__attribute__((unused)) String& s) {
    //GP_BUILD(s);
    BUILD_BEGIN();
}
inline void GP_SHOW() {
